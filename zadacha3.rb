# Задача 3. Напишите программу на Ruby, которая позволит пользователю ввести несколько имён (без фамилий) через пробел. На выходе вывести имена в алфавитном порядке и напечатать каждое второе имя в обратном порядке.
